export default function Header({ activeTab, onTabChange, onFetchNews, onFetchVideos, fetching }) {
  return (
    <header className="fixed top-0 w-full z-50 h-12 flex justify-between items-center px-4 lg:px-6"
      ...
      <div className="flex items-center gap-2">
        ...
        {activeTab !== 'Ideas' && (
          <button onClick={activeTab === '葡萄牙新闻' ? onFetchNews : onFetchVideos}
            disabled={fetching}
